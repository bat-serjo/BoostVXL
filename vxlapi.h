...
#define _XL_EXPORT_API     __stdcall
  ...
  #ifndef BUILD_DLL_FOR_MSVC
    #define _XL_EXPORT_DECL  __declspec(dllimport) _XL_EXPORT_API
    #define _XL_EXPORT_DEF   __declspec(dllimport) _XL_EXPORT_API
  #else
    #define _XL_EXPORT_DECL  __declspec(dllexport) _XL_EXPORT_API
    #define _XL_EXPORT_DEF   __declspec(dllexport) _XL_EXPORT_API
  #endif
...
// the pshpack1.h which is shiped with BCB 6 has
...
#define XL_TRANSCEIVER_TYPE_TWIN_CAN_1041A_MAG   0x0080  //!< TWINcab with two TJA1041A, magnetically isolated
...
// FlexRay PiggyBacks
#define XL_TRANSCEIVER_TYPE_PB_FR_1080           0x0201 //!< refer to \\vistrpnifs1\data\Hardware\Projects\cab-piggy-cartridge\!Technical_Info_CANcab_CANpiggy.xls
...
//------------------------------------------------------------------------------
#define XL_TRANSCEIVER_CAPABILITY_NONE           ((unsigned int)     0)
#define XL_TRANSCEIVER_CAPABILITY_HIGHSPEED      ((unsigned int)     1)
...
#define XL_TRANSCEIVER_RESNET_NA                  0
#define XL_TRANSCEIVER_RESNET_MASTER              1
#define XL_TRANSCEIVER_RESNET_MASTER_STBY         2
#define XL_TRANSCEIVER_RESNET_SLAVE               3
...
typedef struct s_xl_channel_config {
          ...
          unsigned int        transceiverState;         //!< transceiver state
          ...
          unsigned int        channelBusCapabilities;   //!< what buses are supported and which are possible to be activated
...
#define XL_DAIO_CAPTURE_NONE                    0x00000000  // no capture is defined     
#define XL_DAIO_CAPTURE_PWM                     0x00000001  // capture is on PWM signal
#define XL_DAIO_CAPTURE_DIGITAL_INPUT_4         0x00000002  // capture is on digital input 4
#define XL_DAIO_CAPTURE_FREQ_10000KHZ           0x00000100  // setting for capture counter: using 10 MHz 
#define XL_DAIO_CAPTURE_FREQ_5000KHZ            0x00000200  //                              using 5 Mhz 
#define XL_DAIO_CAPTURE_FREQ_2500KHZ            0x00000400  //                              using 2,5 Mhz 
#define XL_DAIO_CAPTURE_FREQ_1250KHZ            0x00000800  //                              using 1,25 MHz  
...
#define RX_FIFO_MOST_QUEUE_SIZE_MAX                  131072 
...
#define XL_MOST_LIGHT_FULL                                3
#define XL_MOST_LIGHT_3DB                                 4
...
#define XL_MOST_NO_QUEUE_OVERFLOW                    0x0000
#define XL_MOST_QUEUE_OVERFLOW                       0x8000
#define XL_MOST_COMMAND_FAILED                       0x4000
#define XL_MOST_INTERNAL_OVERFLOW                    0x2000
#define XL_MOST_MEASUREMENT_NOT_ACTIVE               0x1000
#define XL_MOST_QUEUE_OVERFLOW_ASYNC                 0x0800
#define XL_MOST_QUEUE_OVERFLOW_CTRL                  0x0400
...
#define XL_FR_FRAMEFLAG_STARTUP                   ((unsigned short) 0x0001)
#define XL_FR_FRAMEFLAG_SYNC                      ((unsigned short) 0x0002)
#define XL_FR_FRAMEFLAG_NULLFRAME                 ((unsigned short) 0x0004)
#define XL_FR_FRAMEFLAG_PAYLOAD_PREAMBLE          ((unsigned short) 0x0008)
#define XL_FR_FRAMEFLAG_FR_RESERVED               ((unsigned short) 0x0010)
...
#define XL_FR_FRAMEFLAG_FRAME_TRANSMITTED         ((unsigned short) 0x8000) 
